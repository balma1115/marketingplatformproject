...
// Validate ..\..\app\mypage\settings\page.tsx
{
  ...
  handler satisfies AppPageConfig<"/mypage/settings">
}
...
// Validate ..\..\app\api\smartplace-keywords\update-place\route.ts
{
  const handler = {} as typeof import("..\\..\\app\\api\\smartplace-keywords\\update-place\\route.js")
  handler satisfies RouteHandlerConfig<"/api/smartplace-keywords/update-place">
}
...
// Validate ..\..\app\api\tracking\status\[jobId]\route.ts
{
  const handler = {} as typeof import("..\\..\\app\\api\\tracking\\status\\[jobId]\\route.js")
  handler satisfies RouteHandlerConfig<"/api/tracking/status/[jobId]">
}

// Validate ..\..\app\api\user\change-password\route.ts
{
  const handler = {} as typeof import("..\\..\\app\\api\\user\\change-password\\route.js")
  handler satisfies RouteHandlerConfig<"/api/user/change-password">
}

// Validate ..\..\app\api\user\naver-ads-config\route.ts
{
  const handler = {} as typeof import("..\\..\\app\\api\\user\\naver-ads-config\\route.js")
  handler satisfies RouteHandlerConfig<"/api/user/naver-ads-config">
}

// Validate ..\..\app\api\user\organization\route.ts
{
  const handler = {} as typeof import("..\\..\\app\\api\\user\\organization\\route.js")
  handler satisfies RouteHandlerConfig<"/api/user/organization">
}
