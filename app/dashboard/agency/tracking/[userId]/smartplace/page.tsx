...
import { ArrowLeft, TrendingUp, BarChart, Globe } from 'lucide-react'
...
export default function AgencySmartPlacePage() {
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            ...
            <div className="text-2xl font-bold text-green-600">
              {activeKeywords.filter(k => k.organicRank && k.organicRank <= 5).length}개
            </div>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <div className="text-sm text-gray-500 mb-1">광고 노출</div>
            <div className="text-2xl font-bold text-blue-600">
              {activeKeywords.filter(k => k.adRank).length}개
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="px-4 py-3 bg-gray-50 border-b">
            <h3 className="font-semibold text-gray-700">키워드 순위 현황</h3>
          </div>
